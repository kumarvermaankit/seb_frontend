...
const ENDPOINT = "https://seb.onrender.com"
var socket, selectedChatCompare;

const SingleChat = ({ fetchAgain, setFetchAgain }) => {
  const { user, selectedChat, setSelectedChat, notification, setNotification ,setScore} =
    ChatState();
  ...
  const fetchAllMessages = async () => {
    ...
    try {
      ...
      // const { data: data2 } = await axios.get("/api/analyze", config)
            ...
            {!selectedChat.isGroupChat ? (
              ...
              >
                <Box display="flex" flexDir="column" alignItems="flex-start">
                  ...
                  <Box minH="10px">
                    {<Text fontWeight={5} fontSize="12px">{emotion}</Text>}
                  </Box>
                </Box>
          ...
          >
            {loading ? (
              ...
              <div className="message">
                {<ScrollableChat messages={messages} setemotion={setemotion} />}
              </div>
            )}
          </Box>
          <FormControl
